...
nts::c4011::c4011(std::string const &name) : AComponent(name, 14)
{
  ...
  pinComputeFunction[2] = std::bind(&c4011::computeInput, this, 2);
  pinComputeFunction[3] = std::bind(&c4011::computeOutput, this, 3);
  // gate NAND 2
  pinComputeFunction[5] = std::bind(&c4011::computeInput, this, 5);
  pinComputeFunction[6] = std::bind(&c4011::computeInput, this, 6);
  pinComputeFunction[4] = std::bind(&c4011::computeOutput, this, 4);
  // gate NAND 3
  pinComputeFunction[8] = std::bind(&c4011::computeInput, this, 8);
  pinComputeFunction[9] = std::bind(&c4011::computeInput, this, 9);
  pinComputeFunction[10] = std::bind(&c4011::computeOutput, this, 10);
  // gate NAND 4
  pinComputeFunction[12] = std::bind(&c4011::computeInput, this, 12);
  pinComputeFunction[13] = std::bind(&c4011::computeInput, this, 13);
  pinComputeFunction[11] = std::bind(&c4011::computeOutput, this, 11);
  // VSS
  pinComputeFunction[7] = std::bind(&c4011::computeOutput, this, 7);
  // VDD
  pinComputeFunction[14] = std::bind(&c4011::computeOutput, this, 14);
